...
- **包含内置应用**：Welcome、Notepad、Settings、Terminal、Explorer、Browser、TaskManager。
...
| **TaskManager** | 远端宿主 OS 任务管理器（CPU/内存/磁盘/网络/GPU 占用 + 进程列表） | 已实现（MVP） |
