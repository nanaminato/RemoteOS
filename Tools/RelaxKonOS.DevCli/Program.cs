...
Commands:
  ...
  launch <app-id>
  uninstall <app-id>
  settings --server <https://host:port> catalog|time|preview-time|apply-time|environment-target|environment|preview-environment|apply-environment|operation|rollback [options]
